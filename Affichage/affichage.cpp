...
void display(std::vector<Coureur>& coureurs) {
	...
	DINNextRegular.loadFromFile("ressources/DIN Next W01 Regular.ttf");
	DINNextBold.loadFromFile("ressources/DIN Next W01 Bold.ttf");
	TungstenBold.loadFromFile("ressources/Tungsten-Bold.ttf");
	...
	Texture run;
	run.loadFromFile("ressources/run.png");
	Texture fail;
	fail.loadFromFile("ressources/fail.png");
	Texture win;
	win.loadFromFile("ressources/win.png");
	Texture play;
	play.loadFromFile("ressources/play.png");
	Texture pause;
	pause.loadFromFile("ressources/pause.png");
	Texture forward;
	forward.loadFromFile("ressources/forward.png");
	Texture backward;
	backward.loadFromFile("ressources/backward.png");
	Texture end;
	end.loadFromFile("ressources/end.png");
	Texture begin;
	begin.loadFromFile("ressources/begin.png");
	...
	while (window.isOpen()) {
		...
		for (auto const& c : coureurs) {
			...
			leftText.setColor(Color(15, 25, 35));
			...
			rightText.setColor(Color(15, 25, 35));
